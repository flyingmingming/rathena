...
#define SCRIPT_CONSTANTS_HPP
	...
	//new find me
	export_constant(SC_EXPBOOST_VIPRED);
	export_constant(SC_JEXPBOOST_VIPRED);
	export_constant(SC_ITEMBOOST_VIPRED);	
	//
	...
	export_constant(SC_VIPSTATE_BLUE);
	export_constant(SC_VIPSTATE_RED);
	...
	export_deprecated_constant2("SI_VIPSTATE_BLUE",2001);
	export_deprecated_constant2("SI_VIPSTATE_RED",2002);
	export_deprecated_constant2("SI_VIPSTATE",2100);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	export_constant(EFST_VIPSTATE_BLUE);
	export_constant(EFST_VIPSTATE_RED);
